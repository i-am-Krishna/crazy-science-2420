...
export const setCart = (params)=>(dispatch)=>{
    ...
    return axios.get('https://database-lovoda-clone-production.up.railway.app/api/Cart',params).then((res)=>dispatch({type:types.CART_SUCCESS,payload:res.data})).catch((err)=>dispatch({type:types.CART_FAILURE,payload:err}))
}

 
export const addCart = (params)=>(dispatch)=>{
    dispatch({type:types.ADD_CART_REQUEST})
    return axios.post("https://database-lovoda-clone-production.up.railway.app/api/Cart",params)
...
export const deleteCart =(id)=>(dispatch)=>{
    ...
    return axios.delete(`https://database-lovoda-clone-production.up.railway.app/api/Cart/${id}`)
